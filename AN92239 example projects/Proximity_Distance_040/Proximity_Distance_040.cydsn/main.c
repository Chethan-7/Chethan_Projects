...
*
* @par Description
*    This file contains the main source code for Proximity_Distance_040 example
...
*    1. CY8CKIT-040 PSoC 4000 Pioneer Development Kit
...
/* Macro to enable Tx8 data out on P3[0] */
/* Note the following before enabling Tx8:
 *     Enabling Tx8 leads to visible flickering in LEDs when LEDs are ON. 
...
CY_ISR(TimerIsr)
{
     ...
     * GCC 4.7.3: 13.91us
     * MDK 4.54:  9.45us
     * Note that above timings are measured on silicon (using CY8CKIT-040).
